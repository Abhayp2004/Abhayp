    ...
    >
      ...
      <section className="flex flex-col items-center md:w-1/2 text-center space-y-6 md:space-y-8">
        ...
        <button
          ...
          type="button"
        >
          <Link href="https://x.com/a_parekh55?s=11" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
        ...
        >
          <Link
            href="mailto:parekhabhay50@gmail.com" // Replace with your actual email
        ...
        <button
          ...
          type="button"
        >
          <Link href="https://github.com/Abhayp2004" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
        ...
        <button
          ...
          type="button"
        >
          <Link href="https://www.linkedin.com/in/abhay-parekh-80aa5a298/" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
